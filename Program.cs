...
namespace Branching_Project
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine((packageLength * packageWidth * packageHeight) * packageWeight);
            ...
            Console.WriteLine("Your estimatedTotal for shipping this package is");
            int estimatedTotal = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine(estimatedTotal);
            Console.ReadLine();
